...
exports.getStretch2 = (req, res, next) => {
...
exports.postStretch2 = (req, res, next) => {
...
exports.getStretch3 = (req, res, next) => {
...
exports.postStretch3 = (req, res, next) => {
    console.log('Post request!');
    const body = [];
    req.on('data', (chunk) => {
        body.push(chunk);
